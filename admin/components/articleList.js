...
;var locals_for_with = (locals || {});(function (Date, articles, timea, timeb) {;pug_debug_line = 1;pug_debug_filename = "articleList.pug";
if (articles) {
...
;pug_debug_line = 12;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "\u003Ctr\u003E";
;pug_debug_line = 13;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "\u003Ctd\u003E";
;pug_debug_line = 13;pug_debug_filename = "articleList.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = article.title) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
;pug_debug_line = 14;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "\u003Ctd\u003E";
;pug_debug_line = 14;pug_debug_filename = "articleList.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = article.author) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
;pug_debug_line = 15;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "\u003Ctd\u003E";
;pug_debug_line = 15;pug_debug_filename = "articleList.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = article.category) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
;pug_debug_line = 16;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "\u003Ctd class=\"text-center\"\u003E";
;pug_debug_line = 16;pug_debug_filename = "articleList.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = article.date) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
;pug_debug_line = 17;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "\u003Ctd class=\"text-center\"\u003E";
;pug_debug_line = 17;pug_debug_filename = "articleList.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = article.state) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
;pug_debug_line = 18;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "\u003Ctd class=\"text-center\"\u003E";
;pug_debug_line = 19;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "";
;pug_debug_line = 19;pug_debug_filename = "articleList.pug";
...
;pug_debug_line = 19;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "";
;pug_debug_line = 20;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "\n";
;pug_debug_line = 20;pug_debug_filename = "articleList.pug";
pug_html = pug_html + "";
;pug_debug_line = 20;pug_debug_filename = "articleList.pug";
...
}}.call(this,"Date" in locals_for_with?locals_for_with.Date:typeof Date!=="undefined"?Date:undefined,"articles" in locals_for_with?locals_for_with.articles:typeof articles!=="undefined"?articles:undefined,"timea" in locals_for_with?locals_for_with.timea:typeof timea!=="undefined"?timea:undefined,"timeb" in locals_for_with?locals_for_with.timeb:typeof timeb!=="undefined"?timeb:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}