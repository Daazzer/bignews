...
pug_html = pug_html + (null == (pug_interp = commonNewsItem.intro) ? "" : pug_interp);
}
else {
;pug_debug_line = 10;pug_debug_filename = "commonNewsList.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 10;pug_debug_filename = "commonNewsList.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = commonNewsItem.intro) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
}
